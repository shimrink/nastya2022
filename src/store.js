...
export const state = {
	...
	gifs: [
		...
		{title: 'Нейронки', url: neyroGif, alt: 'Handiwork', text: 'С появлением искусственного интеллекта появилось целое поле для творческих экспериментов. А когда нейросети научились «рисовать» арты — они стали моими незаменимыми помощниками в тренировке навыков и создании дизайн-концептов!'},
	],
}