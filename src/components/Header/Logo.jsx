		...
		<Wrapper m={media}>
			...
			>
				<Path
					...
					fillRule='evenodd'
					clipRule='evenodd'
					d='M34.6248 0L0 93L17.421 93C29.035 93 40.4685 88.1118 46.5575 82.978C52.6466 77.8442 57.0408 71.7947 58.6286 61.5648L69.3798 93H85L50.1148 0H34.6248ZM54.5212 49.1877L42.4349 13.2671H42.1746L19.2787 81.0546C29.1788 80.6904 39.1964 77.5974 44.5671 71.2977C49.9379 64.998 53.3588 57.5819 54.5212 49.1877Z'
				/>
			</Svg>
		</Wrapper>
	)
